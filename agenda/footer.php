    ...
    <div id="footer_content">
        ...
        <div class="footer-links">
            <ul class="footer-list">
                ...
                <li><a href="#" class="footer-link">Agendamento de Bicicletas</a></li>
                <li><a href="#" class="footer-link">Entrega e Coleta</a></li>
                <li><a href="#" class="footer-link">Manutenção Rápida</a></li>
            </ul>
