...
<head>
    ...
    <link rl="stylesheet" href="./css/carrosel.css">
    <meta charset="UTF-8">
...
<?php include('header.php'); ?>
    ...
    <div class="carousel-container">
        ...
        <img src="./assets/bike1.jpeg" alt="Imagem 1">
        <img src="./assets/bike2.jpeg" alt="Imagem 2">
        <img src="./assets/bike3.jpeg" alt="Imagem 3">
        <img src="./assets/bike4.jpeg" alt="Imagem 4">
        <img src="./assets/bike5.jpeg" alt="Imagem 5">
        <img src="./assets/bike6.jpeg" alt="Imagem 6">
        <img src="./assets/bike7.jpeg" alt="Imagem 7">
        <img src="./assets/bike8.jpeg" alt="Imagem 8">
    </div>
    </div>
